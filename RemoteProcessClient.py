...
class RemoteProcessClient:
    ...
    def read_buildings(self):
        ...
        for _ in xrange(building_count):
    ...
    def read_byte_array(self, nullable):
        ...
        if nullable:
            ...
            if count <= 0:
                return RemoteProcessClient.EMPTY_BYTE_ARRAY
